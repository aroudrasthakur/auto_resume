...
class MockAdapter(AIProvider):
    ...
    def generate_content(
        ...
        for exp in experience_raw:
            ...
            bullets = [{"bullet": (b.get("bullet", b.get("highlight", str(b))) if isinstance(b, dict) else str(b))} for b in bullets_raw]
            experience.append({
        ...
        if include_projects:
            for proj in projects_raw:
                ...
                bullets = [{"bullet": (b.get("bullet", str(b)) if isinstance(b, dict) else str(b))} for b in bullets_raw]
