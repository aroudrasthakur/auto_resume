...
# Import models from backend when available
# For now, we'll create Base here
Base = declarative_base()

# Import all models to ensure they're registered
try:
    # This will be available after backend models are created
    # For now, we'll use autogenerate with explicit table definitions
    pass
except ImportError:
    pass
